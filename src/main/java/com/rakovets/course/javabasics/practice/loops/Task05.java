...
public class Task05 {
    public static void main(String[] args) {
        ...
        double healthDecreasePerHour = healthPoints;
        for (int i = 1; healthDecreasePerHour > 0; i++) {
            double resultHealthPoints = healthDecreasePerHour * regenerationPercentFromCurrentHealth / 100 + healthDecreasePerHour;
            healthDecreasePerHour = resultHealthPoints - averageDamagePerHour;
            if (healthDecreasePerHour <= 0) {
