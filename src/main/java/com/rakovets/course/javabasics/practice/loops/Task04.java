...
public class Task04 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= hoursAfterRespawn; i++) {
            double resultHealthPointsPerHour = healthPointsIncreased * regenerationPercentFromCurrentHealth / 100;
            healthPointsIncreased = healthPointsIncreased + resultHealthPointsPerHour;
        }
        long result = (long) healthPointsIncreased;
